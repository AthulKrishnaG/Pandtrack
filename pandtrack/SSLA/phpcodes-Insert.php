...
if(isset($_POST["btnsymptomsadd"]))
{
	...
	$symptomsArray = $_POST['d_s_name']; // array of selected symptoms
...
VALUES (NULL, '$symptoms', '$d_s_date_of_onset', '$in_date', '$up_date')";
	$insertresult=mysqli_query($dbconnection,$insertqry);
	//Check whether the query was successful or not
	if($insertresult) 
	{
...
if(isset($_POST["btnmedicinesadd"]))
{
	...
	//Insert into Registation table
	$insertqry="INSERT INTO  `pantra`.`medicines` (`d_m_id` ,`d_m_name` ,`d_m_dose`,`d_m_duration`,`d_m_indate` ,`d_m_update`)
VALUES (NULL, '$d_m_name', '$d_m_dose', '$d_m_duration', '$d_m_indate', '$d_m_update')";
	$insertresult=mysqli_query($dbconnection,$insertqry);
	//Check whether the query was successful or not
	if($insertresult) 
	{
...
{
	$discharge_p_name= $_POST['discharge_p_name1'];
