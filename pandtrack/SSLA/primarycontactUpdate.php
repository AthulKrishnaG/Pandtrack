            ...
            <div class="col-md-12">
              ...
              $c_p_state = $row['c_p_state'];
                ...
                <div class='form-group row'>
                          ...
                          <div class='col-md-9'>
                          <select id='c_p_state' name='c_p_state' class='form-control'>
                          <option value='' disabled>--Select State--</option>
                          <option value='Kerala' " . ($c_p_state == 'Kerala' ? 'selected' : '') . ">Kerala</option>
                          <option value='Tamil Nadu' " . ($c_p_state == 'Tamil Nadu' ? 'selected' : '') . ">Tamil Nadu</option>
                          <option value='Karnataka' " . ($c_p_state == 'Karnataka' ? 'selected' : '') . ">Karnataka</option>
                          <option value='Maharashtra' " . ($c_p_state == 'Maharashtra' ? 'selected' : '') . ">Maharashtra</option>
                        </select>
                          </div>
                        </div>
                        ...
                        <div class='form-group row'>
                          ...
                          <div class='col-md-9'>
                            <select id='c_p_district' name='c_p_district' class='form-control'>
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const selectedState = "<?php echo $c_p_state; ?>";
    const selectedDistrict = "<?php echo $c_p_district; ?>";
