...
if(isset($_POST["btnsymptomsUp"]))
{
	...
	$d_s_name = implode(",", $_POST['d_s_name']);
...
if(isset($_POST["btnmedicinesup"]))
{
	...
	$updateqry="UPDATE `pantra`.`medicines` SET d_m_name='$d_m_name', d_m_dose='$d_m_dose', d_m_duration='$d_m_duration', d_m_update='$d_m_update' WHERE d_m_id='$d_m_id'";
	$updateresult = mysqli_query($dbconnection,$updateqry);
	if($updateresult) 
	{
...
if(isset($_POST["btncontactUp"]))
{
	...
	$updateqry="UPDATE `pantra`.`contact` SET c_state='$c_state', c_district='$c_district', c_visited_places='$c_visited_places', c_explain_the_activities='$c_explain_the_activities', c_explanation_activities_date='$c_explanation_activities_date', c_explanation_activities_time='$c_explanation_activities_time',c_up_date='$c_up_date' WHERE c_id='$c_id'";
	$updateresult = mysqli_query($dbconnection,$updateqry);
	if($updateresult) 
	{
...
if(isset($_POST["btnprimarycontactUp"]))
{
	...
	$updateqry="UPDATE `pantra`.`primary_contact` SET c_p_person='$c_p_person',  c_p_state='$c_p_state', c_p_district='$c_p_district', c_p_town='$c_p_town', c_p_place='$c_p_place',c_p_up_date='$c_p_up_date' WHERE c_p_id='$c_p_id'";
	$updateresult = mysqli_query($dbconnection,$updateqry);
	if($updateresult) 
	{
